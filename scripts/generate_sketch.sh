CUDA_VISIBLE_DEVICES=0 python -m diffusion.train_diffusion \
    ...
    trainer.test_output_dir=./outputs/sketch/ \
    trainer.resume_from_checkpoint=./ckpt/Diffusion_sketch_sq30_1500k.ckpt \
